...
namespace Zing.Localization.Services {
    public class DefaultLocalizedStringManager : ILocalizedStringManager {
        ...
        const string CoreLocalizationFilePathFormat = "~/Core/App_Data/Localization/{0}/Zing.core.po";
        const string ModulesLocalizationFilePathFormat = "~/Modules/{0}/App_Data/Localization/{1}/Zing.module.po";
        const string ThemesLocalizationFilePathFormat = "~/Themes/{0}/App_Data/Localization/{1}/Zing.theme.po";
        const string RootLocalizationFilePathFormat = "~/App_Data/Localization/{0}/Zing.root.po";
        const string TenantLocalizationFilePathFormat = "~/App_Data/Sites/{0}/Localization/{1}/Zing.po";
        ...
        // "~/Core/App_Data/Localization/<culture_name>/Zing.core.po";
        // "~/Modules/<module_name>/App_Data/Localization/<culture_name>/Zing.module.po";
        // "~/Themes/<theme_name>/App_Data/Localization/<culture_name>/Zing.theme.po";
        // "~/App_Data/Localization/<culture_name>/Zing.root.po";
        // "~/App_Data/Sites/<tenant_name>/Localization/<culture_name>/Zing.po";
