...
{
    public class DefaultZingHostContainer : IZingHostContainer, IDependencyResolver
    {
        private readonly IContainer _container;


        public DefaultZingHostContainer(IContainer container)
        {
        ...
        TService IZingHostContainer.Resolve<TService>()
        {
