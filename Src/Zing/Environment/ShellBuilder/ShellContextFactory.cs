    ...
    public class ShellContextFactory : IShellContextFactory
    {
        ...
        public ShellContext CreateShellContext(ShellSettings settings)
        {
            ...
            using (var standaloneEnvironment = shellScope.CreateWorkContextScope())
            {
                ...
                currentDescriptor = new ShellDescriptor();
                currentDescriptor.SerialNumber = 5;
                ...
                currentDescriptor.Features = descriptorFeatures;
                currentDescriptor.Parameters = new List<ShellParameter>();
            }
