...
{
    public class DefaultZingHost : IZingHost, IShellSettingsManagerEventHandler, IShellDescriptorManagerEventHandler
    {
        ...
        void IZingHost.ReloadExtensions()
        {
            DisposeShellContext();
        }

        void IZingHost.BeginRequest()
        {
            Logger.Debug("BeginRequest");
            BeginRequest();
        }

        void IZingHost.EndRequest()
        {
            Logger.Debug("EndRequest");
            EndRequest();
        }

        IWorkContextScope IZingHost.CreateStandaloneEnvironment(ShellSettings shellSettings)
        {
