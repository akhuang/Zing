    ...
    public class ExtensionManager : IExtensionManager
    {
        ...
        private Feature LoadFeature(FeatureDescriptor featureDescriptor)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new ZingException(T("Error while loading extension '{0}'.", extensionId), ex);
            }
        ...
        {
            foreach (ZingFeatureAttribute featureAttribute in type.GetCustomAttributes(typeof(ZingFeatureAttribute), false))
            {
