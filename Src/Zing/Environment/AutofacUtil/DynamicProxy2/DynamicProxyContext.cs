...
namespace Zing.Environment.AutofacUtil.DynamicProxy2
{
    public class DynamicProxyContext
    {
        const string ProxyContextKey = "Zing.Environment.AutofacUtil.DynamicProxy2.DynamicProxyContext.ProxyContextKey";
        const string InterceptorServicesKey = "Zing.Environment.AutofacUtil.DynamicProxy2.DynamicProxyContext.InterceptorServicesKey";
        ...
        public void AddProxy(Type type)
        {
            ...
            lock (_cache)
            {
                ...
                _cache[type] = _proxyBuilder.CreateClassProxyType(type,null, ProxyGenerationOptions.Default);
            }
        }
