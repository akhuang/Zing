...
using Zing.WebApi.Routes;
using Zing.Mvc.ModelBinders;
using Zing.Tasks;
using Zing.Logging;
...
namespace Zing.Environment
{
    ...
    {
        private readonly Func<Owned<IZingShellEvents>> _eventsFactory;
        ...
        public DefaultZingShell(
            Func<Owned<IZingShellEvents>> eventsFactory,
