...
{
    public class DefaultZingWebApiHttpHttpControllerActivator : IHttpControllerActivator
    {
        private readonly HttpConfiguration _configuration;

        public DefaultZingWebApiHttpHttpControllerActivator(HttpConfiguration configuration)
            : base()
        {
