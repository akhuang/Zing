...
using Zing.WebApi.Extensions;

namespace Zing.WebApi {
    public class DefaultZingWebApiHttpControllerSelector : DefaultHttpControllerSelector, IHttpControllerSelector {
        private readonly HttpConfiguration _configuration;

        public DefaultZingWebApiHttpControllerSelector(HttpConfiguration configuration)
            : base(configuration)
        {
