...
//using Zing.ContentManagement.Records;
    ...
    public abstract class AbstractDataServicesProvider : IDataServicesProvider
    {
        ...
        public Configuration BuildConfiguration(SessionFactoryParameters parameters)
        {
            ...
            return Fluently.Configure()
                ...
                .ExposeConfiguration(cfg => cfg.EventListeners.LoadEventListeners = new ILoadEventListener[] { new ZingLoadEventListener() })
                .BuildConfiguration()
                ;
        }
        ...
        [Serializable]
        class ZingLoadEventListener : DefaultLoadEventListener, ILoadEventListener
        {
