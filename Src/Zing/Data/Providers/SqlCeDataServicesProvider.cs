...
namespace Zing.Data.Providers {
    public class SqlCeDataServicesProvider : AbstractDataServicesProvider {
        ...
        public SqlCeDataServicesProvider(string dataFolder, string connectionString) {
            ...
            _fileName = Path.Combine(_dataFolder, "Zing.sdf");
        }
        ...
        public override IPersistenceConfigurer GetPersistenceConfigurer(bool createDatabase) {
            ...
            persistence = persistence.Driver(typeof(ZingSqlServerCeDriver).AssemblyQualifiedName);
            return persistence;
        }
        ...
        public class ZingSqlServerCeDriver : SqlServerCeDriver {
